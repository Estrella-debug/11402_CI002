...
#### 模擬運算(k = 8為例)：
- Range: left=1, right=15. 假設 mid = 11
- Count Less Equal (11):
    - 從左下角 12 開始：12 > 11 (上移) $\rightarrow$ 10 <= 11 (計數+2, 右移) $\rightarrow$ 11 <= 11 (計數+2, 右移) $\rightarrow$ 13 > 11 (上移)
    - 最終計算出小於等於 11 的數量，並根據結果調整 left 或 right
